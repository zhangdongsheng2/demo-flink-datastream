...
public class KafkaConfigUtil {
     ...
     */
    public static DataStreamSource<InputData> buildSource(StreamExecutionEnvironment env, String topic, Long time) throws IllegalAccessException {
        ParameterTool parameterTool = (ParameterTool) env.getConfig().getGlobalJobParameters();
        Properties props = buildKafkaProps(parameterTool);
        FlinkKafkaConsumer<InputData> consumer = new FlinkKafkaConsumer<>(
                topic,
                new InputDataSchema(),
                props);
        //重置offset到time时刻
